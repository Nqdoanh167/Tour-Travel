...
module.exports = /*#__PURE__*/function () {
  function Email(user, url) {
    ...
    this.url = url;
    this.from = "Doanh Dev <".concat(process.env.EMAIL_USERNAME, ">");
  }
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              html = pug.renderFile(path.join(__dirname, "templates/".concat(template, ".pug")), {
                to: this.to,
                url: this.url,
                subject: subject
      ...
      var _sendWelcome = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return this.send('welcome', 'Welcome to the Tour Travel!');
            case 2:
            case "end":
