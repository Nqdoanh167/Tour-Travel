      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 5:
            ...
            return _context2.abrupt("return", next(new AppError('Document is not found', 404)));
          case 8:
            res.status(200).json({
              status: 'success',
              data: doc
...
exports.createOne = function (Model, data) {
  return catchAsync( /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            if (data) obj = Object.assign({}, data, req.body);else obj = req.body;
            _context3.next = 5;
