...
var HandleFactory = require('../controllers/handleFactory');
var upload = require('../utils/upload');
var catchAsync = require('../utils/catchAsync');
exports.uploadUserPhoto = upload.single('photo');
exports.uploadUser = catchAsync( /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 2:
          ...
          filteredBody = filterObj(req.body, 'name', 'phone', 'photo'); // 3) Update user document
          _context3.next = 5;
...
exports.getGuide = catchAsync( /*#__PURE__*/function () {
...
exports.getManyUser = catchAsync( /*#__PURE__*/function () {
...
exports.getAllId = catchAsync( /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 3:
          ...
          res.status(200).json({
            status: 'success',
            data: (_userIds$ = userIds[0]) === null || _userIds$ === void 0 ? void 0 : _userIds$.ids
          });
        case 5:
        case "end":
...
exports.getAdmin = catchAsync( /*#__PURE__*/function () {
