...
messageSchema.pre('save', /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return this.model('Conversation').findById(this.conversationId);
        case 3:
          ...
          return _context.abrupt("return", next(new AppError('Conversation not found', 404)));
        case 6:
          if (conversation.members.includes(this.senderId)) {
            _context.next = 8;
            break;
          }
          return _context.abrupt("return", next(new AppError('You can not chat at this Conversation', 401)));
        case 8:
          // Thiết lập receiveId bằng userId khác với senderId trong cuộc trò chuyện
          this.receiveId = conversation.members.find(function (receiveId) {
            return receiveId !== _this.senderId;
          });
        case 9:
          next();
        case 10:
