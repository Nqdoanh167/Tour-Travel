...
bookingSchema.pre('save', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(next) {
    var _this = this;
    var tour, newStartDates;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return Tour.findById(this.tour);
        case 2:
          tour = _context.sent;
          newStartDates = tour.startDates.filter(function (date) {
            return date.getTime() !== _this.startDate.getTime();
          });
          console.log('newStartDates', newStartDates);
          _context.next = 7;
          return Tour.findByIdAndUpdate(this.tour, {
